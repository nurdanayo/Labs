...
snd1 = pygame.mixer.Sound("/Users/macbook/Downloads/Frank Ocean - Thinkin Bout You.mp3") # грузим треки
snd2 = pygame.mixer.Sound("/Users/macbook/Downloads/13. Close To You.mp3")
...
text1 = basicFont.render('Frank ocean', True, 'black', 'white') # создаём текста
text2 = basicFont2.render('Close to you', True, 'black', 'white')
