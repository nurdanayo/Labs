...
image = pygame.image.load("/Users/macbook/Downloads/mickeyclock.png") 
img = pygame.transform.scale(image, (res))
screen = pygame.display.set_mode(res) # resolution of image

# right hand - minutes
minutes = pygame.image.load("/Users/macbook/Downloads/righthand.png")
# left hand - seconds
seconds = pygame.image.load("/Users/macbook/Downloads/lefthand.png")
