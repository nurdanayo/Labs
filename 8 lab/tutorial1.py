...
class Coin(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.image = pygame.transform.scale(pygame.image.load("/Users/macbook/Downloads/Coin-2.png").convert_alpha(), (75, 100))
...
class Enemy(pygame.sprite.Sprite):
      def __init__(self):
        ...
        self.image = pygame.transform.rotate(pygame.transform.scale(pygame.image.load("/Users/macbook/Downloads/Enemy-2.png"), (100, 200)), 180)
        self.rect = self.image.get_rect()
        self.rect.center=(random.randint(30, w-30),0) 
...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__() 
        self.image = pygame.transform.scale(pygame.image.load("/Users/macbook/Downloads/Player-2.png"), (100, 200))
        self.rect = self.image.get_rect()
...
while True:
    ...
    if pygame.sprite.spritecollideany(P1, enemies):
          pygame.mixer.Sound('/Users/macbook/Downloads/tsis8_media_crash.wav').play()
          time.sleep(0.5)
